...
class SettingsConstants:
    ...
    SCREENSAVER_LOGO_BOUNCE = "logo_bounce"
    SCREENSAVER_STARFIELD = "starfield"
    ALL_SCREENSAVERS = [
        (SCREENSAVER_LOGO_BOUNCE, "Logo Bounce"),
        (SCREENSAVER_STARFIELD, "Star Field")
    ]
...
class SettingsDefinition:
    ...
    settings_entries: List[SettingsEntry] = [
        ...
        SettingsEntry(category=SettingsConstants.CATEGORY__DISPLAY,
                      ...
                      default_value=SettingsConstants.SCREENSAVER_LOGO_BOUNCE),
