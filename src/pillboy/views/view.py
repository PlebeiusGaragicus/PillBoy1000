...
from pillboy.gui.components import FontAwesomeIconConstants, GUIConstants
from pillboy.gui.screens import RET_CODE__POWER_BUTTON
from pillboy.gui.screens.screen import RET_CODE__BACK_BUTTON, DireWarningScreen, LargeButtonScreen, PowerOffScreen, PowerOffNotRequiredScreen, ResetScreen, WarningScreen
from pillboy.models.threads import BaseThread
from pillboy.models import Settings
from pillboy.views import NotYetImplementedView
...
class MainMenuView(View):
    def run(self):
        ...
        from pillboy.gui.screens import LargeButtonScreen
        menu_items = [
            (("Scan", FontAwesomeIconConstants.QRCODE), ScanView),
            (("Seeds", FontAwesomeIconConstants.KEY), NotYetImplementedView),
